...
\usepackage[left=1cm, right=1cm, top=2cm, bottom=2cm, headheight=1cm, headsep=.5cm, footskip=1cm]{geometry}
...
\definecolor{titlecolor}{rgb}{0,0,0}%{0.18, 0.08, 0.05}
...
\titleformat{\section}
  ...
  {\tikz[baseline=(char.base)]{
    ...
    \begin{scope}
        \shade[rounded corners=.5em, left color=titlecolor!30, right color= titlecolor, overlay, remember picture] ($(char.east)+(-5em,-.8em)$) rectangle ++(5.1em,1.6em);
    \end{scope}
    \node[text=white, inner sep=.5em] (char) {\thesection};}}
  {.5em}
  {}
...
\titleformat{\subsection}
  ...
  {\tikz[baseline=(char.base)]{
    ...
    \begin{scope}
        \shade[rounded corners=.5em, left color=titlecolor!30, right color= titlecolor, overlay, remember picture] ($(char.east)+(-4em,-.8em)$) rectangle ++(4.1em,1.6em);
    \end{scope}
    \node[text=white, inner sep=.5em] (char) {\thesubsection};}}
  {.5em}
  {}
...
\titleformat{\subsubsection}
  ...
  {\tikz[baseline=(char.base)]{
    ...
    \begin{scope}
        \shade[rounded corners=.5em, left color=titlecolor!30, right color= titlecolor, overlay, remember picture] ($(char.east)+(-3em,-.8em)$) rectangle ++(3.1em,1.6em);
    \end{scope}
    \node[text=white, inner sep=.5em] (char) {\thesubsubsection};}}
  {.5em}
  {}
...
\newcommand*\customchapter[2]{
  ...
  \vfill
  \begin{center}
    \large\bfseries But du chapitre
  \end{center}
  \textit{#2}
  \vfill
  \newpage
...
\newcommand{\drapeaunfp}[2]{
    \begin{tikzpicture}
        \def\flagwidth{#1}
        \def\flagheight{#2}
    
        \fill[nfpgreen] (0,0) -- (0,\flagheight) -- (\flagwidth / 3,\flagheight) -- cycle;
        \fill[nfpred] (0,0) -- (\flagwidth / 3,\flagheight) -- (2*\flagwidth / 3,\flagheight) -- cycle;
        \fill[nfpyellow] (0,0) -- (2*\flagwidth / 3,\flagheight) -- (\flagwidth,\flagheight) -- (\flagwidth,2*\flagheight / 3) -- cycle;
        \fill[nfppurple] (0,0) -- (\flagwidth,2*\flagheight / 3) -- (\flagwidth,\flagheight / 3) -- cycle;
        \fill[nfppink] (0,0) -- (\flagwidth,\flagheight/ 3) -- (\flagwidth,0) -- cycle;
    
    
        \draw[nfpred, very thin] (0,0) rectangle (\flagwidth, \flagheight);
    \end{tikzpicture}
}

\newcommand{\drapeaufrance}[2]{
    \begin{tikzpicture}
        \def\flagwidth{#1}
        \def\flagheight{#2} 
        \fill[myblue] (0,0) rectangle (\flagwidth / 3, \flagheight);
        \fill[white] (\flagwidth / 3,0) rectangle (2* \flagwidth / 3, \flagheight);
        \fill[myred] (2* \flagwidth / 3, 0) rectangle (\flagwidth, \flagheight);
        \draw[black, very thin] (0,0) rectangle (\flagwidth,\flagheight);
    \end{tikzpicture}
}
